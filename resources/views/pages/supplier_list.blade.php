        ...
        <div class="padding">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="padding">
                        <a class="btn btn-primary" href="supplier/add-supplier" role="button">Add supplier</a>
                    </div>
                    <div class="box">
                        ...
                        <table class="table">
                            ...
                            @foreach($suppliers as $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('supplier/update-supplier?supplier_id='.$supplier->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo">
                                            <span>Edit
                                            </span>
                                        </a>
                                        <a href="{{url('supplier/delete-supplier?supplier_id='.$supplier->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo"
