                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::model($customer,['url' => $customer ? 'customer/'.$customer->id.'/update' : 'customer/customer-store','method'=>'post','file'=>true,'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) !!}
