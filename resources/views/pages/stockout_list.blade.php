        ...
        <div class="padding">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="padding">
                        <a class="btn btn-primary" href="stockout/add-stockout" role="button">Add Products to Stock</a>
                    </div>
                    <div class="box">
                        ...
                        <table class="table">
                            ...
                            @foreach($stockouts as $stock)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('stockout/update-stockout?stockout_id='.$stock->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo">
                                            <span>Edit
                                            </span>
                                        </a>
                                        <a href="{{url('stockout/delete-stockout?stockout_id='.$stock->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo"
