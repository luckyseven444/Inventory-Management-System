                            ...
                            <div class="panel-body">
                                ...
                                @foreach($old_val as $key=>$value)
                                        <div class="form-group ss appendHere row">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="col-md-2 ">
                                                    {!! Form::select('product[]',$products ,'', ['class' => 'form-control hit' , 'placeholder' => 'Product', 'id'=>'product', 'style'=> $errors->first('product.'.$key) ? 'border:1px solid  red' : '']) !!}
                                                    <div class="tree">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 ">
                                                ...
                                                <div class="col-md-2 ">
                                                    {!! Form::text('cost[]', null, ['class' => 'form-control total', 'placeholder' => 'Total', 'style'=> $errors->first('cost.'.$key) ? 'border:1px solid  red' : '']) !!}
                                                </div>
                                                <div class="col-md-2">
                                ...
                                @else
                                    ...
                                    <div class="form-group ss appendHere row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="col-md-2 ">
                                                {!! Form::select('product[]',$products ,'', ['class' => 'form-control hit', 'placeholder' => 'Product', 'id'=>'product']) !!}
                                                <div class="tree">
                                                </div>
                                            </div>
                                            <div class="col-md-2 ">
                                            ...
                                            <div class="col-md-2 ">
                                                {!! Form::text('cost[]', null, ['class' => 'form-control total', 'placeholder' => 'Total']) !!}
                                            </div>
                                            <div class="col-md-2">
                                                {!! Form::button('+', ['class' => 'btn btn-sm btn-success add','id'=>'button'] ) !!}
                                                {!! Form::button('-', ['class' => 'btn btn-sm btn-danger  remove','id'=>'button2'] ) !!}
