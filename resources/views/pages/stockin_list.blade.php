        ...
        <div class="padding">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="padding">
                        <a class="btn btn-primary" href="stockin/add-stockin" role="button">Add Products to Stock</a>
                    </div>
                    <div class="box">
                        ...
                        <table class="table">
                            ...
                            @foreach($stockins as $stock)
                                <tr>
                                    ...
                                    <td>{{$stock->products->product}}
                                    </td>
                                    <td>{{$stock->lot}}
                                    </td>
                                    <td>{{$stock->suppliers->name}}
                                    </td>
                                    <td>{{$stock->unit_price}}
                                    </td>
                                    <td>{{$stock->quantity}}
                                    ...
                                    <td>{{$stock->challans->challan}}
                                    </td>
                                    <td>{{$stock->cost}}
                                    </td>

                                    <td>
                                        <a href="{{url('stockin/update-stockin?stockin_id='.$stock->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo">
                                            <span>Edit
                                            </span>
                                        </a>
                                        <a href="{{url('stockin/delete-stockin?stockin_id='.$stock->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo"
