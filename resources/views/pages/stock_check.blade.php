                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Check Stock Info.
                            </div>
                            <div class="panel-body">
                                {!! Form::open(['url' => '']) !!}
                                <div class="form-group row ">
                                    {!! Form::label('Check stock', 'Product:', ['class' => 'col-lg-2 control-label']) !!}
                                    <div class="col-lg-10">
                                        {!! Form::select('product',$products, '', ['class' => 'form-control sit', 'placeholder' => 'Select Product']) !!}
                                        <div class="error">{{ $errors->first('Check stock') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="free">
...
@push('stockscript')
    <script>
        $(document).ready(function () {
                ...
                $(document).on("click", ".sit", function(){

                        var field_val=$(this).val();
                        $.ajax({
                                type : 'GET',
                                url: '{{url('/check-stock-ajax')}}',
                                data: {
