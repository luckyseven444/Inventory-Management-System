        ...
        <div class="padding">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="padding">
                        <a class="btn btn-primary" href="customer/add-customer" role="button">Add customer</a>
                    </div>
                    <div class="box">
                        ...
                        <table class="table">
                            ...
                            @foreach($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('customer/update-customer?customer_id='.$customer->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo">
                                            <span>Edit
                                            </span>
                                        </a>
                                        <a href="{{url('customer/delete-customer?customer_id='.$customer->id)}}"
                                           class="md-btn md-raised m-b-sm w-xs indigo"
